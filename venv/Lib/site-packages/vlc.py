...
vlc_path = ""
with open("vlc_path.txt", "r") as vlc_path_file:
    vlc_path = vlc_path_file.read().strip()
            ...
            try:  # some registry settings
                ...
                for r in w.HKEY_LOCAL_MACHINE, w.HKEY_CURRENT_USER:
                    try:
                        ...
                        """
                        key_path = vlc_path.replace("/", "\\")
                        key_path = key_path[key_path.index("\\"):]
                        while not key_path[0].isalpha():
                            key_path = key_path[1:]
                        r = w.OpenKey(vlc_path[0], key_path)
                        """
